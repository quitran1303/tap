...
export default function NewPatientPopup({ open, onClose }) {
	const handleClose = () => {
		onClose(false);
	};
	...
	return (
		<React.Fragment>
			<Dialog open={open} onClose={handleClose} maxWidth="xs">
				...
				<DialogContent>
					<DialogContentText>Input info of the new patient for this record.</DialogContentText>
					<Box sx={{ flexGrow: 1 }} justify-content="center">
						<Grid display="flex" container spacing={2} alignItems="center" justifyContent="center">
							<Grid item xs={12}>
								<TextField label="Name" fullWidth={true} />
							</Grid>
							<Grid item xs={12}>
								<TextField label="DOB" fullWidth={true} />
							</Grid>
							<Grid item xs={12}>
								<TextField label="Doctor" fullWidth={true} />
							</Grid>
							<Grid item xs={12}>
								<TextField label="Last visit date" fullWidth={true} />
							</Grid>
							<Grid item xs={12}>
								<TextField label="Image taken date" fullWidth={true} />
							</Grid>
						</Grid>
					</Box>
				</DialogContent>
